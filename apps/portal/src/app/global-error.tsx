      ...
      <body className="min-h-screen bg-background text-foreground">
        <div className="flex min-h-screen w-full items-center justify-center py-12">
          <div className="flex w-full max-w-[560px] flex-col items-center gap-3 px-6">
            ...
            {/* Root layout crashed — status link alone is insufficient escalation.
                Operator carve-out: include a contact-support mailto here only. */}
            <p className="text-caption text-muted-foreground">
              ...
              {" · "}
              <a
                href="mailto:support@hud.ai?subject=Platform%20failed%20to%20initialize"
                className="underline underline-offset-2 hover:text-foreground"
              >
                Contact support
              </a>
