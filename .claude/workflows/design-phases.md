...
- Every phase exits via a self-review at `.intermediate/reviews/{phase}-self-review-{YYYY-MM-DD}.md` — see [`phase-self-review.md`](phase-self-review.md). Reviews are process artifacts (audit trail of the gate run), not canonical record.
